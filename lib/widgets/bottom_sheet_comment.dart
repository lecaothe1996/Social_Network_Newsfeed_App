...
class BottomSheetComment {
  // Singleton
  static final BottomSheetComment _instance = BottomSheetComment._internal();

  factory BottomSheetComment() => _instance;

  BottomSheetComment._internal();

  Future showBottomSheet(String id, BuildContext context) {
